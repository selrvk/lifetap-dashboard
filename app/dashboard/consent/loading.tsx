  ...
  return (
    <div style={{ minHeight: "100vh", background: "var(--bg)" }}>
      ...
      <main style={{ padding: "32px 32px 48px", maxWidth: 1400, margin: "0 auto" }}>
        ...
        <Shimmer width={200} height={28} style={{ marginBottom: 6 }} />
        <Shimmer width={280} height={13} style={{ marginBottom: 24 }} />
        <Shimmer height={60} style={{ borderRadius: 12, marginBottom: 20 }} />
        <div style={{ display: "flex", gap: 12, marginBottom: 20 }}>
          {[0, 1, 2, 3, 4].map((i) => <Shimmer key={i} height={90} style={{ flex: "1 1 200px", borderRadius: 14 }} />)}
        </div>
